...
function ChannelList({channels, selectedChannel, readMore}) {
                  ...
                  >
                    ...
                    >
                      <i className="fa fa-angle-double-right mx-1 mx-md-2 mx-lg-3"
                         aria-hidden="true"></i>
                      <h4
                        className={channel === selectedChannel ? "channel-name mb-0 text-dark" : "channel-name mb-0 news-line"}>
                    ...
                    <div className="live-icon-wrapper">
                      {channel.streamUrlList.some((stream) => stream.isLive) && (
                        <img
                          src={`${process.env.PUBLIC_URL}/live-icon.webp`}
                          alt="live now"
                          className="live-icon"
                        />
                      )}
